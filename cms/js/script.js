$(function(){
	...
	function initialize() {
		...
		var mapProp = {
			center:new google.maps.LatLng(-22.968471,-43.185525),
			zoom:14,
			scrollwheel: false,
			 styles: [{
			stylers: [{
	...
	function carregarDinamico(){
		$('[realtime]').click(function(){
			...
			$('.boxdinamico').hide();
			$('.boxdinamico').load(include_path+'pages/'+pagina+'.php');

			setTimeout(function(){
				initialize()
				addMarker(-22.968471,-43.185525,'',"Nosso Escritório",undefined,false)

			},1000);

			$('.boxdinamico').fadeIn(1000);
